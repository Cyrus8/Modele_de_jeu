...
public class MenuJeu extends MenuAbstrait {
	...
	protected String[] nomOptions() {
		String[] noms = {"FenÍtre simple","Jeu","Gestion du son",
				"Fichier des scores","Gestion d'image","FenÍtre PoËme", "Quitter"};
		return noms;
	}
	...
	protected void lancerOption(int i) {
		switch (i){  
		case 0 : new FenetreSimple("FenÍtre simple");break;
		...
		case 5 : new FenetreTest("Test d'une fenÍtre");break;
